...
export const alt = "Contact CopyPasteLearn";
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
          ...
          <div style={{ fontSize: 22, color: "#a1a1aa", lineHeight: 1.4 }}>
            Questions about courses, enterprise training, or partnerships? We'd love to hear from you.
          </div>
        </div>
        <div
          style={{
