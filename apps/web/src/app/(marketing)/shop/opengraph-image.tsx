...
export const alt = "CopyPasteLearn Shop — DevOps ebooks, templates & bundles";
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 8, marginBottom: 40 }}>
          ...
          <div style={{ fontSize: 22, color: "#a1a1aa", lineHeight: 1.4 }}>
            Production-tested Ansible, Terraform, and Kubernetes resources. Instant download, lifetime updates, EU VAT included.
          </div>
        </div>
        <div
          style={{
