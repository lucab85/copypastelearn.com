...
export const alt = "CopyPasteLearn Lesson";
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
          ...
          <div style={{ fontSize: 22, color: "#a1a1aa", lineHeight: 1.4 }}>
            Expert-led video instruction with hands-on interactive labs in real environments.
          </div>
        </div>
        <div style={{ display: "flex", gap: 16, marginTop: 40 }}>
          {["Video", "Code Snippets", "Hands-On Lab"].map((t) => (
            <div key={t} style={{ padding: "10px 20px", borderRadius: 8, backgroundColor: "#18181b", border: "1px solid #27272a", fontSize: 16, fontWeight: 600 }}>
              {t}
            </div>
          ))}
        </div>
