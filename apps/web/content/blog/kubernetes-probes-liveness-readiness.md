...
description: "Configure Kubernetes liveness, readiness, and startup probes correctly. HTTP, TCP, and exec check types with proper timing, thresholds, and common misconfiguration fixes."
---
